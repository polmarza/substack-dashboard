...
The screenshots below use **fictitious data** generated by `npm run demo` — no real publication is shown. The interface is in Spanish.
...
**Any post**, with its traffic sources, most-clicked links and first-week daily views:
