...
The screenshots below use **fictitious data** generated by `npm run demo` — no real publication is shown. The interface is in Spanish. The red marker is an annotation added for this documentation; it is not part of the interface.
